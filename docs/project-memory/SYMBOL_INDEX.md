...
| `rust/gui/src/lib/app-server-client.ts` | 2 | symbol | `ProtocolThreadItem` |  |
| `rust/gui/src/lib/app-server-client.ts` | 12 | symbol | `ProtocolThread` |  |
| `rust/gui/src/lib/app-server-client.ts` | 25 | symbol | `ProtocolGoalSnapshot` |  |
| `rust/gui/src/lib/app-server-client.ts` | 37 | symbol | `ProtocolGoalView` |  |
| `rust/gui/src/lib/app-server-client.ts` | 42 | symbol | `ProtocolEventEnvelope` |  |
| `rust/gui/src/lib/app-server-client.ts` | 50 | symbol | `SessionRow` |  |
| `rust/gui/src/lib/app-server-client.ts` | 64 | symbol | `AppServerOutcome` |  |
| `rust/gui/src/lib/app-server-client.ts` | 68 | symbol | `appServerRequest` |  |
| `rust/gui/src/lib/app-server-client.ts` | 70 | symbol | `outcome` |  |
| `rust/gui/src/lib/app-server-client.ts` | 78 | symbol | `ProtocolSequenceGate` |  |
| `rust/gui/src/lib/app-server-client.ts` | 83 | symbol | `previous` |  |
| `rust/gui/src/lib/app-server-client.ts` | 89 | symbol | `normalizeWorkspacePath` |  |
| `rust/gui/src/lib/app-server-client.ts` | 91 | symbol | `normalized` |  |
| `rust/gui/src/lib/app-server-client.ts` | 98 | symbol | `historicalFallbackTitle` |  |
| `rust/gui/src/lib/app-server-client.ts` | 100 | symbol | `normalized` |  |
| `rust/gui/src/lib/app-server-client.ts` | 103 | symbol | `withoutPrefix` |  |
| `rust/gui/src/lib/app-server-client.ts` | 104 | symbol | `chars` |  |
| `rust/gui/src/lib/app-server-client.ts` | 107 | symbol | `threadToSessionRow` |  |
| `rust/gui/src/lib/app-server-client.ts` | 109 | symbol | `userMessages` |  |
| `rust/gui/src/lib/app-server-client.ts` | 110 | symbol | `assistantMessages` |  |
| `rust/gui/src/lib/app-server-client.ts` | 111 | symbol | `toolCalls` |  |
| `rust/gui/src/lib/app-server-client.ts` | 112 | symbol | `snippet` |  |
| `rust/gui/src/lib/app-server-client.ts` | 113 | symbol | `firstUserMessage` |  |
